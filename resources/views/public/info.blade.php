...
@section('content')
    ...
    <section class="bg-[#10222b] text-[#dee6e9]">
        <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6 flex flex-col gap-4">
            ...
            <p class="text-[#dee6e9]/80 max-w-2xl text-pretty leading-relaxed">Artículos claros y breves sobre seguridad, buenas prácticas y prevención de accidentes con pirotecnia.</p>
        </div>
    </section>
            ...
            <div class="grid gap-5 md:grid-cols-3">
                ...
                <div class="flex flex-col h-full rounded-2xl border border-gray-300/50 shadow-sm relative transition-all hover:-translate-y-1 hover:shadow-md">
                    <div class="relative aspect-4/3 overflow-hidden rounded-t-lg">
                        <img src="{{ Storage::url($publication->coverImage->path) }}" alt="{{ $publication->coverImage->alt_text }}" class="h-full w-full object-cover">
                    </div>
