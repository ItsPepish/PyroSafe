...
@section ('content')
    <section class="relative -mt-16 h-screen w-full overflow-hidden">
        ...
        >
            <h1
                class="max-w-3xl text-4xl leading-tight font-bold text-balance sm:text-5xl md:text-6xl"
            >
    ...
    <section class="border-b border-[#d6e0e4]">
        <div class="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 sm:px-6">
            <div class="max-w-2xl">
                <h2 class="text-3xl font-semibold text-[#10222b]">
            ...
            <div class="grid gap-5 md:grid-cols-3">
                ...
                @endphp
                    ...
                    >
                        <span
                            class="grid size-12 place-items-center rounded-xl {{ $bgColor }} {{ $txtColor }}"
                        >
                            <x-dynamic-component
                        ...
                        <a
                            href="{{ $feature['href'] }}"
                            class="{{ $txtColor }} inline-flex items-center gap-1.5 font-semibold"
                        >
                            {{ $feature['link_text'] }}
    ...
    <section class="border-b border-[#d6e0e4] bg-[#ecf3f5]">
        ...
        >
            ...
            <div>
                <h2 class="text-3xl font-semibold text-balance text-[#10222b]">
                ...
                <ul class="mt-8 grid gap-4 sm:grid-cols-2">
                    <li class="flex gap-3">
                        <span
                            class="mt-0.5 grid size-6 shrink-0 place-items-center rounded-full bg-[#0f7688]/12 text-[#0f7688]"
                        >
                        ...
                        <span>
                            <span
                                class="block text-sm font-semibold text-[#10222b]"
                                >Distancia segura</span
                            >
                            <span
                                class="mt-0.5 block text-justify text-sm leading-relaxed text-[#5e6b73]"
                    ...
                    >
                        ...
                        <div class="flex flex-1 flex-col gap-4 p-4">
                            ...
                            >
                                ...
                                >
                                <span
                                    class="inline-flex items-center gap-1 text-xs text-[#5e6b73]"
                                >
        ...
        <div class="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 sm:px-6">
            ...
            <ol class="grid gap-5 md:grid-cols-3">
                @foreach ($reportSteps as $reportStep)
                    <li
                        class="flex flex-col gap-4 rounded-2xl border border-[#d6e0e4] bg-white p-6"
                    >
                        <span
                            class="text-sm font-semibold text-[#0f7688]"
                            >{{ $reportStep['step'] }}</span
                        >
                        <span
                            class="grid size-10 place-items-center rounded-xl bg-[#0f7688]/12 text-[#0f7688]"
                        >
                            <x-dynamic-component
                                :component="'icons.' . $reportStep['icon']"
                            />
                        </span>
                        <h3 class="font-semibold text-[#10222b]">
                            {{ $reportStep['title'] }}
                        </h3>
