<header class="sticky top-0 z-50 w-full border-b border-[#d6e0e4] bg-white">
    ...
    >
        ...
        <a
            href="/reporte"
            class="hidden cursor-pointer rounded-lg bg-[#df1b27] px-4 py-2 font-semibold text-white transition-colors hover:bg-[#b3141e] md:flex"
            >Reportar riesgo</a
        >
        <button
            type="button"
            ...
            aria-expanded="false"
            class="inline-flex size-10 items-center justify-center rounded-lg text-[#10222b] transition-colors hover:bg-[#ecf3f5] md:hidden"
        >
    ...
    <div
        id="mobile-menu"
        data-mobile-menu
        class="hidden border-t border-[#d6e0e4] px-4 py-2 sm:px-6"
    >
