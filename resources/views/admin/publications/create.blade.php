...
@section ('content')
    <div class="flex h-full flex-col gap-5">
        <div class="flex flex-col gap-2">
            <h1 class="text-2xl font-semibold text-[#10222b]">Nueva publicación</h1>
            <p class="text-sm text-[#5e6b73]">Agrega un articulo a la biblioteca de información preventiva.</p>
        </div>
        <form
