...
@section ('content')
    <div class="flex h-full flex-col gap-5">
        ...
        <div class="flex flex-col gap-2">
            <h1 class="text-4xl font-bold text-[#10222b]">
                Folio: {{ $report->folio }}
            </h1>
        ...
        >
            <div class="flex flex-wrap items-center gap-8">
                ...
                <form
                    action="{{ route('admin.reports.update-status', $report) }}"
                    method="POST"
                ...
                >
                    ...
                    <label
                        for="status"
                        class="text-sm font-medium text-[#5e6b73]"
                        >Estado del reporte:
                    </label>
                    <select
                        name="status"
        ...
        <section
            class="flex flex-col gap-2 rounded-2xl border border-[#d6e0e4] bg-[#ecf3f5] p-4"
        >
